...
function Course_details(props) {
    ...
    const selectedCategory = data?.data?.find((v) => v._id === id)
                ...
                <div className="container">
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-4 mb-4 mb-lg-0">
                            <div className="card bg-black text-center p-3 rounded-4">
                                <Carousel>
                                    {selectedCategory?.course_img?.map((v) => (
                        ...
                        <div className="col-lg-8 text-white">
                            <h6 className="mb-3 bg-primary d-inline-block px-3 py-1 rounded">
                                {selectedCategory?.name}
                            </h6>

                            <h1 className="fw-bold">Hi, I am {selectedCategory?.description}</h1>
                            <h5 className="text-light mb-3">Graphic Designer</h5>
